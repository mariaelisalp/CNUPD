...
class StorePeopleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'missing' => 'required',
            'missing_time_date' => 'nullable|date|after:birth_date|before_or_equal:today',
            'time_date' => 'nullable|date|before_or_equal:today||after:birth_date',
    ...
    public function messages(): array{
        return [
            ...
            'missing_time_date.after' => 'Data inválida',
            'time_date.after' => 'Data inválida',
