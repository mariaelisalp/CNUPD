        ...
        <div>
            <form action="{{route('people.index_desaparecidos')}}" method="GET">
                <div class="row">
                    ...
                    <input type="text" name= "search" class="larger-input" id= "search" style="width: 300px;" placeholder= "Pesquisar por Nome, Cidade, Estado, etc" value= "{{$search}}">
                </div><br>
                ...
                <div>
                    ...
                    <a href="{{route('people.index_desaparecidos')}}">Limpar</a>
                </div>
            </form>
        </div>
    </div><br>
