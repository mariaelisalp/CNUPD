...
@section('content')
    ...
    Data: {{\Carbon\Carbon::parse($people->time_date)->tz('America/Sao_Paulo')->format('d/m/Y H:m:s')}} <br><br>
    ...
    <a href="{{route('people.edit', ['people' => $people->id])}}"><button>Editar</button></a><br>
